This is a reference to the Webcolumn.js Object.
...
|-----------	|----------------------------------------------------	|-------	|
| `rightOnly` 	| You only have to pass in a `right`<br> array of blocks, and it renders an empty left column on larger screens and adjusts accordingly for smaller screens. 	| <img src="https://imgur.com/d3xoWzr.png" width="250"/>  	|
| `oneColumn` 	| Pass in a prop called `center`<br> which is an array of blocks, and it renders the blocks in a single column. Best used for wide maps. 	|  <img src="https://imgur.com/co29paq.png" width="250"/>	|
...
|----------- |-----------	|----------------------------------------------------	|-------	|
| `width` 	| '2/3' | The width of the image is 66% of the width of its parent	| <img src="https://imgur.com/pcJBo2r.png" width="250"/>  	|
| `hide` | true	| Places the images in the block, but only shows an outline of the image instead of the image. This is used to hide images that have not been licenses for publishing yet 	|  <img src="https://imgur.com/C2tMu13.png" width="250"/>	|
