	...
	renderOldText = () => {
		...
		const paraOne = () => (
			<span>
				...
				Scarborough rapid transit line.<sup>1</sup>
				<br />
				<br /> This first phase of the plan would cost $2.5 billion and create 50,000 jobs, with $1.5 billion
				from the province, $500 million from Metro Toronto, and $500 million from the private sector.
				<sup>2</sup> The plan, released at the end of the early 1990s recession, was seen as both a jobs creator
				and a way to rebuild ridership on the TTC subway system, which had fallen over 15 per cent between 1988
				to 1993.<sup>3</sup>
				<br />
				<br />
				...
				<sup>5</sup>
				<br />
				<br /> Meanwhile, plans for a subway loop connecting the Yonge and Spadina subways were retained but
				expanded to include proposed stations at York University and with a more northerly alignment on Steeles
				Avenue rather than through the Finch hydro corridor as originally proposed.<sup>6</sup> Similarly, plans
				for extensions to the Bloor-Danforth subway and Scarborough rapid transit lines were retained, with an
				extension to Sherway Gardens on the Bloor-Danforth subway proposed as a second phase of the plan.
				<sup>7</sup>
		...
		const paraTwo = () => (
			<p>
				...
				without directly increasing Ontario’s deficit.<sup>11</sup>
				<br />
				<br /> Following the recession, the provincial government’s deficit at the time – a record $10 billion
				was worrying for many and a key issue in the following 1995 provincial elections.<sup>12</sup> Likewise,
				municipal officials in Metro Toronto were concerned with the cost associated with the four subway
				projects proposed and their effect on municipal finances, which would see cost-cutting on municipal
				programs to support the 25 per cent municipal funding necessary for the projects.<sup>13</sup> Metro
				Toronto staff had earlier recommended Metro Toronto council to approve only the Eglinton West subway and
				Spadina extension to York University, leading to clashes between the province and Toronto municipal
				officials, with the province threatening to cut their share of funding for other municipal projects if
				only two of the four projects were approved.<sup>14</sup>
				<br />
				<br />
...
>>>>>>> 57345b57f90716f5776d17de3b655c46a086de6d
				...
				<div className="RTEPD1col2">
					...
					<div className="RTEPD1col2text">
						...
						to begin tunnelling in mid-1996.<sup>21</sup>
						<br />
						<br /> However, the election of a new Progressive Conservative provincial government running
						...
						},
						{
							...
							text: () => (
								<div>
									...
									Avenue to be constructed between 1989-1994.<sup>16</sup> Then, a downtown subway
									...
									the years of 1994-1999.<sup>17</sup> Then, between 1999-2004, rapid transit on
									Eglinton Avenue West would be constructed, initially as a partially grade-separated
									busway, with the possibility of converting it to a subway later.<sup>18</sup>{' '}
						...
						},
						{
							...
							text: () => (
								<div>
									...
									elections.<sup>12</sup> Likewise, municipal officials in Metro Toronto were
									...
									support the 25 per cent municipal funding necessary for the projects.<sup>13</sup>{' '}
							...
							right: [
								{
									...
									text: () => (
										<div>
											...
											assessments on the Eglinton West, Sheppard, Scarborough RT extension, and
											Spadina loop projects had been completed, with construction starting on the
											former two projects by late summer of 1994.<sup>20</sup> By early 1995,
											excavation had already progressed for tail tracks on the Eglinton West
											subway and procurement of tunnel boring machines had been underway for the
