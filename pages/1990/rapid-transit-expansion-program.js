	...
	renderView() {
		return (
			<div className="body__img-con">
				<img src="/images/RTEP.png" alt="" className="body__img" />
			</div>
		);
	}
	renderText() {
		...
		return (
			<div className="body__text-con">
				...
				<p className="body__text-p column2easy">
					The 1993 Rapid Transit Expansion Program was the culmination of the NDP provincial government’s
					study of the previous Liberal government’s Let’s Move transit plan. The highlights for phase one – a
					Sheppard subway between Yonge Street and Don Mills Road, a subway on Eglinton Avenue West from
					Eglinton West Station in the east to a new “York City Centre” located at Black Creek Drive in the
					west, and eventually to Pearson Airport, an extended Spadina subway reaching York University, and an
					extension to the Scarborough rapid transit line.<sup>1</sup> This first phase of the plan would cost
					$2.5 billion and create 50,000 jobs, with $1.5 billion from the province, $500 million from Metro
					Toronto, and $500 million from the private sector.<sup>2</sup> The plan, released at the end of the
					early 1990s recession, was seen as both a jobs creator and a way to rebuild ridership on the TTC
					subway system, which had fallen over 15 per cent between 1988 to 1993.<sup>3</sup>
					At the core of the NDP’s new plan was many of the same projects found in both the Let’s Move and
					Network 2011 plans: A Sheppard subway was made a priority in this plan, with provincial funding to
					match, unlike the previous conditional support for the line under the previous Liberal provincial
					government.<sup>4</sup> On Eglinton, plans for a busway were upgraded to a subway, pleasing
					municipal officials in the surrounding area and especially those from the then City of York, where
					the first phase of the future subway line was to terminate in a new central business district dubbed
					“York City Centre”.<sup>5</sup> Meanwhile, plans for a subway loop connecting the Yonge and Spadina
					subways were retained but expanded to include proposed stations at York University and with a more
					northerly alignment on Steeles Avenue rather than through the Finch hydro corridor as originally
					proposed.<sup>6</sup> Similarly, plans for extensions to the Bloor-Danforth subway and Scarborough
					rapid transit lines were retained, with an extension to Sherway Gardens on the Bloor-Danforth subway
					proposed as a second phase of the plan.<sup>7</sup>
					<div className="italy italybold" style={{ padding: '0.5em' }}>
						...
						Sheppard subway, an extension of the Scarborough rapid transit line, and an extension of the
						Spadina line to York University.
					</div>
				</p>
				<div className="body_divide body_divideVL">
					<img src={'/images/RTEPA.jpg'} alt="" />
				...
				<p className="body__text-p column2easy">
					Investment into these projects by the provincial government, Metro Toronto, and the private sector
					were to be funnelled through a new crown corporation, the Ontario Transportation Corporation, which
					with a budget separate from the province’s revenues enabled the provincial government to proceed
					with projects without directly increasing Ontario’s deficit.<sup>11</sup> Following the recession,
					the provincial government’s deficit at the time – a record $10 billion was worrying for many and a
					key issue in the following 1995 provincial elections.<sup>12</sup> Likewise, municipal officials in
					Metro Toronto were concerned with the cost associated with the four subway projects proposed and
					their effect on municipal finances, which would see cost-cutting on municipal programs to support
					the 25 per cent municipal funding necessary for the projects.<sup>13</sup> Metro Toronto staff had
					earlier recommended Metro Toronto council to approve only the Eglinton West subway and Spadina
					extension to York University, leading to clashes between the province and Toronto municipal
					officials, with the province threatening to cut their share of funding for other municipal projects
					if only two of the four projects were approved.<sup>14</sup>
					<br />
					<br />In the end, both the Sheppard and Eglinton West subways were approved while the Spadina and
					Scarborough rapid transit extensions, with little political support, were left in limbo.<sup>15</sup>{' '}
					A municipal election during the midst of the debate temporarily paused the discussion but both
					projects were eventually voted against by Metro Toronto council, leading to calls for the province
					...
					funding them through provincial funds only, or taking control of the TTC completely.<sup>17</sup>
				</p>
				<div className="body_divide body_divideVL">
					<img src={'/images/RTEPD.jpg'} alt="" />
					<div className="body__img-p italy" style={{ marginTop: '1em' }}>
						The environmental assessment of the Scarborough rapid transit line extension identified four new
						station locations approximately following the route of Highland Creek.<sup>18</sup> Three stops
						would be initially built at the intersection of Progress Avenue and Markham Road, the
						intersection of Milner Avenue and Progress Avenue, and at approximately the intersection of
						Sheppard Avenue and Markham Road. A station would be built in the future on Bellamy Station
						adjacent to Highland Creek. Metro Toronto council was unsupportive of the project.
					</div>
				</div>
				<div className="body_divide body_divideVL">
					<img src={'/images/RTEPD.jpg'} alt="" />
					<div className="body__img-p italy" style={{ marginTop: '1em' }}>
						...
						Stations were proposed at the C.N.R. subdivision at Finch Avenue West, near the intersection of
						Finch Avenue West and Kelle Street, and a station terminating at York University. Council was
						unsupportive of this plan, and it was later cancelled. An extension of the Spadina subway with a
				...
				<div className="column2">
					<div style={{ flex: '1.75' }}>
						...
						<div className="italy">
							...
							subway progresses at the intersection of Sheppard Avenue and Leslie Street in 1998.<sup>24</sup>
						</div>
					</div>
					...
					<div>
						...
						were explored by later provincial and municipal governments.<br />
