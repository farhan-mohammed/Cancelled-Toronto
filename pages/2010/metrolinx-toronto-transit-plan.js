						...
						{ type: 'img', src: '' },
						{
							...
							text: () => (
								<span>
									...
									transportation plan.<sup>4</sup> Eglinton’s high connectivity with several GO
									...
									Scarborough rapid transit line refurbishment and extension.<sup>5</sup> During
						...
						{ type: 'img', src: '' },
						{
							...
							text: () => (
								<span>
									...
									tolls, congestion charges, and development fees<sup>13</sup> By June 2011, further
						...
						},
						{
							...
							text: () => (
								<span>
									...
									later fired Gary Webster.<sup>15</sup> Then, following a series of victories in
						...
						},
						{
							...
							text: () => (
								<span>
									...
									surface light rail or underground subway technology would be more effective.
									<sup>19</sup> Soon after, city staff concluded that Rob Ford’s plan to almost
									exclusively utilise private investment towards extensions of the Sheppard subway
				...
				<WebColumn
					...
					right={[
						{ type: 'img', src: '' },
						{
							...
							text: () => (
								<span>
									...
									to the dismay of the mayor.<sup>21</sup> Appealing to the province, which would have
						...
						},
						{
							...
							text: () => (
								<span>
									...
									transferred from the TTC to the province through Metrolinx.<sup>23</sup>{' '}
									...
									LRT would see completion in 2020.<sup>24</sup> In the end, the Sheppard East LRT was
						...
						},
						{
							...
							text: () => (
								<span>
									The saga for which the Metrolinx/Toronto Transit Plan was created was ultimately a
									blip from the province’s original plan for a watered-down Transit City proposal.
									Although certain elements of the Metrolinx/Toronto Transit Plan from 2011 survive
									today through the current Progressive Conservative administration’s plan for an
									eventual extension of the Sheppard subway eastwards, such a project is neither
									funded or a priority. Meanwhile, Rob Ford’s vision for a fully-underground Eglinton
									LRT was never realized, with current construction on a mixed-grade LRT planned for
									completion in fall of 2021. Despite so, the Metrolinx/Toronto Transit Plan
									represented the culmination of previous transit plans such as the Rapid Transit
