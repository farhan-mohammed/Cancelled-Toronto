                ...
                <WebColumn
                    left={[
                        { type: 'content-title', title: 'Proposed Eglinton Busway' },
                        {
                            ...
                            text: () => (
                                <span>
                                    The proposed Eglinton West rapid transit line was recommended to be constructed initially as a busway.<sup>32</sup> The wide right-of-way along Eglinton Avenue West – originally planned for the Richview Expressway, would allow buses to run in the median, with grade separations at arterial roads.<sup>33</sup> The limited right-of-way in the eastern section meant a short tunnel section would be needed to allow the alignment to veer north-east to the CN Belt Line, where the busway would continue on the surface until reaching Eglinton West Station.<sup>34</sup> Here, images of the MBTA’s Silver Line, a system of bus routes operating along dedicated right-of-ways on the surface and briefly underground show a system with several similarities to what was proposed along Eglinton, albeit in a much more urban setting.<sup>35</sup>
                                </span>
                            ),
                        },
                        {
