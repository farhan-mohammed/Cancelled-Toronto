                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    downtown Toronto to encourage decentralisation.<sup>12</sup>
                                </span>
                            ),
                        },
                    ]}
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    otherwise exceed design capacity if unbuilt.<sup>13</sup> A
                                    ...
                                    to the recommended alignment.<sup>16</sup>
                                </span>
                            ),
                        },
                    ]}
                        ...
                        { type: 'content-title', title: 'A New Downtown Subway' },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    proposal from the same era were also a contender.<sup>17</sup>{' '}
                                    Both elevated and underground options of the alignment were
                                    considered.<sup>18</sup> Given “serious consideration” as a
                                    ...
                                    pavement and sidewalk widths in the area.<sup>19</sup>{' '}
                                    Pedestrian links in the Union Station area would also have been
                                    severely impacted.<sup>20</sup> Here, images show the proposed
                                    ...
                                    eventually recommended.<sup>21</sup> Ultimately, the elevated
                    ...
                    right={[
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    plan.<sup>23</sup> Although a downtown subway would relieve the
                                    then already overburdened Yonge subway line, it was deemed
                                    inconsistent with Metroplan.<sup>24</sup> Varying forms of rapid
                                    transit technology were recommended for each of the lines;
                                    subway technology was assumed for Sheppard, ICTS technology for
                                    the downtown line (although limited changes in alignment
                                    geometry could support a subway), and a bus rapid transit
                                    corridor for Eglinton West (with eventual upgrade to some form
                                    of rail transit).<sup>25</sup> The anticipated growth of the
                                    suburban centres of Scarborough City Centre and North York
                                    Centre as dictated by Metroplan, the high volumes of bus
                                    ridership along Finch and Sheppard Avenues, and a diverse set of
                                    alternatives for relieving downtown transit volumes (including
                                    GO Transit improvements, the then-proposed “Spadina LRT”, and
                                    express buses on streets such as Sherbourne Street) played
                                    important roles in placing a proposed subway on Sheppard Avenue
                                    a priority ahead of a line through downtown.<sup>26</sup>
                                </span>
                            ),
                        },
                    ]}
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    first.<sup>28</sup> Officials from the three municipal bodies
                                    ...
                                    subway – eventually.<sup>29</sup> The plan saw further
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    study of transit proposals in the province.<sup>31</sup>{' '}
                        ...
                        { type: 'content-title', title: 'scarborough town Centre' },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    Sheppard subway.<sup>33</sup> Planning in Metro Toronto at the
                                    ...
                                    within them.<sup>34</sup> New central business districts such as
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    <sup>36</sup> Come 1990 – an election year, the (eventually
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    Network 2011.<sup>39</sup> Meanwhile today, plans for a downtown
