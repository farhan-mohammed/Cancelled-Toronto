	...
	renderView() {
		return (
			<div className="body__img-con">
				<img src="/images/1980.png" alt="" className="body__img" />
			</div>
		);
	}
	renderText1() {
			...
			<div className="body__text-con">
						...
						<div className="x1980Specialcon">
							<p className="x1980Specialmaintext">
								...
								<div className="x1980Specialhah">
									<div className="x1980Specialhah1">
										would allow for transfers between the Yonge-University-Spadina line and the
										future Sheppard subway.<sup>2</sup> All-in-all, the plan would cost $2.7
										billion, 25 per cent paid for by the Metro Toronto government and 75 per cent
										from the provincial government.<sup>3</sup>
										<br /> <br /> Planning for what became of Network 2011 began in 1982, with the
										release of the Accelerated Rapid Transit Study undertaken by Metro Toronto and
										the TTC.<sup>4</sup> The report, which studied four corridors for future rapid
										transit expansion including Eglinton, “Central Radial” (a route downtown via
										existing rail corridors), Sheppard, and the Finch hydro corridor, identified
										potential station, yard, and routing locations, as well as potential costs and
										impacts on the surrounding community and environment.<sup>5</sup> The findings
										of the study were then broken down into three more detailed studies offering
										further analysis of the ridership and feasibility of each of the corridors: the
										Sheppard/Finch Rapid Transit Study, the Downtown Rapid Transit Study, and the
										Eglinton West Rapid Transit Study.<sup>6</sup> The outcomes of these studies and
										the
									</div>
									<div className="blurb x1980Specialblurb">
										Network 2011 at its core was a transit plan that was planned to achieve the
										planning goals of Metropolitan Toronto and their objective of creating multiple
								...
								the proposed Sheppard subway, which would connect two of the identified nodes,
								Scarborough City Centre and North York Centre, was identified as the priority of the
								Network 2011 plan.<sup>8</sup> A downtown subway that would aim to relieve the Yonge
								subway line would follow, followed by rapid transit on Eglinton West, which Network 2011
								recommended to be implemented initially as a partially grade-separated busway that could
								eventually be upgraded to a subway.<sup>9</sup>
							</p>
						</div>
					</div>
				</div> */}
				...
				<div className="body_divide body_divideVL">
					...
					<div className="body__img-p italy" style={{ marginTop: '1em' }}>
						...
						unbuilt.<sup>10</sup> A variety of routings were considered, including a subway along Bay Street
						from Bay Station on the Bloor-Danforth line to Union Station on the Yonge line, but the majority
				...
				<p className="body__text-p column2easy">
					...
					and Peel Region who wanted rapid transit on Eglinton Avenue first.<sup>13</sup> Officials from the
					three municipal bodies were further appalled at the plan’s commitment to construct only a busway on
					Eglinton, rather than a light rail line or a subway, with the plan only specifying that it could be
					replaced with a subway – eventually.<sup>14</sup> The plan saw further opposition from surrounding
					municipal and regional governments including York, Peel, and Durham Regions who sought funding for
				...
				{/* <div className="body_divide body_divideHR">
					<div className="body_divideHR_text">
						<p className="body__text-p">
							Rapid transit expansion in the Network 2011 plan was to be phased over a 26-year timeframe,
							beginning with a Sheppard subway between Yonge Street to Victoria Park Avenue to be
							constructed between 1989-1994.<sup>16</sup> Then, a downtown subway between Pape Station on
							the Bloor-Danforth Line in the east to approximately the intersection of Spadina Avenue and
							Front Street in the west would be constructed in the years of 1994-1999.<sup>17</sup> Then,
							between 1999-2004, rapid transit on Eglinton Avenue West would be constructed, initially as
							a partially grade-separated busway, with the possibility of converting it to a subway later.<sup>18</sup>{' '}
							Finally, between 2004-2010, the Sheppard subway would be extended on both ends from Yonge
							Street to Dufferin Street in the west, and from Victoria Park Avenue to Scarborough City
							Centre in the east.<sup>19</sup>
						</p>
					</div>
					<div className="body_divideHR_img body_divideHR_img19801">
						<div className="body_divideHR_img19801son">
							<img src={imgC} alt="" />
						</div>

						<p className="body__text-p">
							<span className="text_upper text_bold">FIGURE 2:</span> The planned Sheppard subway, when
							fully built, was planned to connect two emerging central business districts, North York
							Centre and Scarborough City Centre. Pictured above is North York Centre, with the
							intersection and western terminus of the first phase of the subway, Sheppard Avenue and
				...
				{/* <div className="body_divide body_divideHL">
					...
					<div className="body_divideHL_text">
						<p className="body__text-p">
							<span className="text_upper text_bold">FIGURE 3:</span> Pictured left, Scarborough City
							Centre, planned eventual terminus of the Sheppard subway and emerging central business
							district.<sup>21</sup> Planning in Metro Toronto at the time de-emphasised growth in the
							downtown, taking action such as restricting office development to protect adjacent
				...
				<p className="body__text-p column2easy">
					...
					The then-Liberal provincial government – who was not involved in the development of the Network 2011
					plan, baulked at the $75 million a year from the province necessary for a full build-out and decided
					to conduct a full study of all transit proposals in the province.<sup>24</sup> Completed in May of
					1988, the report downgraded funding priority of the Sheppard subway in favour of expanding GO
					Transit services and extending the Spadina line towards York Region.<sup>25</sup> By then, the cost
					for completing a Sheppard subway from Yonge Street to Victoria Park Avenue had more than doubled
					from a 1985 estimate of $500 million to an estimate of $1.1 billion in 1989.<sup>26</sup> Come 1990
					– an election year, the (eventually defeated) Liberals kept the Sheppard subway on life support by
					supporting the project only if a portion of the project could be paid for through private sector
					investment and without disrupting funding for their transit plan, dubbed “Let’s Move”.<sup>27</sup>{' '}
					Also retained was plans for rapid transit on Eglinton in the form of a busway to Peel Region but a
					downtown subway and a complete Sheppard subway from Downsview to Scarborough City Centre were
					dropped.<sup>28</sup>
					<br />
					...
					later under the Rapid Transit Expansion Program and opened in 2003, ten years after the original
					proposed opening date of 1993 detailed in Network 2011. Meanwhile today, plans for a downtown subway
					continue to be studied while rapid transit on Eglinton has taken the form of light rail, currently
					under-construction and planned for a 2021 opening.
				</p>
				<h1 className="body__text-h1">Footnotes</h1>
				{footnotes()}
			</div>
