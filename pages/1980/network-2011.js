				...
				<WebColumn
					...
					right={[
						...
						},
						{
							...
							text: () => (
								<span>
 									The plan was to be phased over a 26-year timeframe, with the recommended phasing beginning with a Sheppard subway between Yonge Street to Victoria Park Avenue to be constructed between 1989-1994.<sup>3</sup> Then, a downtown subway between Pape Station on the Bloor-Danforth Line in the east to approximately the intersection of Spadina Avenue and Front Street in the west would be constructed in the years of 1994-1999.<sup>4</sup> Following that, between 1999-2004, rapid transit on Eglinton Avenue West would be constructed, initially as a partially grade-separated busway, with the possibility of converting it to a subway later.<sup>5</sup> Finally, between 2004-2010, the Sheppard subway would be extended on both ends from Yonge Street to Dufferin Street in the west, and from Victoria Park Avenue to Scarborough City Centre in the east.<sup>6</sup> All-in-all, the plan would cost $2.7 billion, 25 per cent paid for by the Metro Toronto government and 75 per cent from the provincial government.<sup>7</sup>
								</span>
							)
						},
						{
							...
							text: () => (
								<span>
									Planning for what became Network 2011 began in 1982, with the release of the
									Accelerated Rapid Transit Study undertaken by Metro Toronto and the TTC.<sup>8</sup>
									...
									community and environment.<sup>9</sup>
								</span>
							)
						},
						{
							...
							text: () => (
								<span>
									The findings of the study were then broken down into three more detailed studies offering further analysis of the ridership and feasibility of each of the corridors: the Sheppard/Finch Rapid Transit Study, the Downtown Rapid Transit Study, and the Eglinton West Rapid Transit Study.<sup>10</sup> From the studies, lines were proposed along Sheppard Avenue, Eglinton Avenue West, and through downtown along a Pape-Eastern-Railway Corridor-Front alignment.<sup>11</sup>
								</span>
							)
						},
						{
							...
							text: () => (
								<span>
									The findings of these studies and the recommended alignments were combined to create Network 2011, which utilised the findings of the three studies to recommend suggested phasing for constructing the plan according to Metro Toronto planning objectives. The Metro Toronto official plan of the time (Metroplan) called for the creation of a multi-centred urban structure within Metro Toronto, with the development of nodes which would act as major employment and activity centres outside downtown Toronto to encourage decentralisation.<sup>12</sup>
								</span>
							)
						}
					]}
						...
						},
						{
							...
							text: () => (
								<span>
									...
									otherwise exceed design capacity if unbuilt.<sup>13</sup> A variety of routings were
									...
									of alignments created a “J” or “U” shape.<sup>14</sup> In the end, a routing along
									Pape-Eastern-Railway Corridor-Front was recommended, with the western terminus
									located at approximately Front Street and Spadina Avenue.<sup>15</sup> An alignment along Front Street and Wellington Street instead of along the railway corridor and Front Street was also recommended as an alternative to the recommended alignment.<sup>16</sup>
								</span>
							)
						}
					]}
					...
					right={[
						{
							...
							text: () => (
								<span>
									As a result, the proposed Sheppard subway (which would connect two of the identified nodes, Scarborough City Centre and North York Centre) was identified as the priority of the Network 2011 plan.<sup>23</sup> Although a downtown subway would relieve the then already overburdened Yonge subway line, it was deemed inconsistent with Metroplan.<sup>24</sup> Varying forms of rapid transit technology were recommended for each of the lines; subway technology was assumed for Sheppard, ICTS technology for the downtown line (although limited changes in alignment geometry could support a subway), and a bus rapid transit corridor for Eglinton West (with eventual upgrade to some form of rail transit).<sup>25</sup> The anticipated growth of the suburban centres of Scarborough City Centre and North York Centre as dictated by Metroplan, the high volumes of bus ridership along Finch and Sheppard Avenues, and a diverse set of alternatives for relieving downtown transit volumes (including GO Transit improvements, the then-proposed “Spadina LRT”, and express buses on streets such as Sherbourne Street) played important roles in placing a proposed subway on Sheppard Avenue a priority ahead of a line through downtown.<sup>26</sup>
								</span>
							)
						}
					]}
						...
						{ type: 'content-title', title: 'North York Centre' },
						{
							...
							text: () => (
								<span>
									...
									of the subway, Sheppard Avenue and Yonge Street, at the lower centre.<sup>27</sup>
								</span>
							)
						},
						{
				...
				<WebColumn
					left={[
						{ type: 'content-title', title: 'scarborough town Centre' },
						{
							...
							text: () => (
								<span>
									Scarborough City Centre, pictured, an emerging central business district that would be the planned eventual terminus of the Sheppard subway.<sup>33</sup> Planning in Metro Toronto at the time de-emphasised growth in the downtown, taking action such as restricting office development to protect adjacent communities and reduce the pressure of redevelopment for historic structures within them.<sup>34</sup> New central business districts such as Scarborough City Centre were intended to receive the majority of new office developments, something planners hoped would decrease the pressure of large amounts of commuters headed downtown in the peak direction by encouraging reverse commuting.<sup>35</sup>
								</span>
							)
						},
						{
					...
					right={[
						{ type: 'img', adjust: { hide: false }, src: 'Network 2011/Scarborough-City-Centre.jpg' },
						{
							type: 'para',
							text: () => (
								<span>
									By then, the cost for completing a Sheppard subway from Yonge Street to Victoria Park Avenue had more than doubled from a 1985 estimate of $500 million to an estimate of $1.1 billion in 1989.<sup>36</sup> Come 1990 – an election year, the (eventually defeated) Liberals kept the Sheppard subway on life support by supporting the project only if a portion of the project could be paid for through private sector investment and without disrupting funding for their own transit plan, dubbed “Let’s Move”.<sup>37</sup> Also retained was plans for rapid transit on Eglinton in the form of a busway to Peel Region but a downtown subway and a complete Sheppard subway from Downsview to Scarborough City Centre were dropped.<sup>38</sup>
								</span>
							)
						},
						{
