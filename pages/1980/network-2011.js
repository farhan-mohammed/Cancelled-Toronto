        ...
        return (
            <div>
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    ...
                                    locations, as well as potential costs and impacts on the
                                    surrounding community and environment.<sup>9</sup>
                                </span>
                            ),
                        },
                    ]}
                ...
                <WebColumn
                    oneColumn={true}
                    center={[
                        { type: 'content-title', title: 'Accelerated Rapid Transit Study' },
                        {
                            type: 'img',
                ...
                <WebColumn
                    oneColumn={true}
                    center={[
                        { type: 'content-title', title: 'Downtown Rapid Transit Study' },
                        {
                            type: 'img',
                            // /images/ already saved
                    ...
                    right={[
                        {
                            ...
                            text: () => (
                                <span>
                                    As a result, the proposed Sheppard subway (which would connect two of the identified nodes, Scarborough City Centre and North York Centre) was identified as the priority of the Network 2011 plan.<sup>24</sup> Although a downtown subway would relieve the then already overburdened Yonge subway line, it was deemed inconsistent with Metroplan.<sup>25</sup> The anticipated growth of the suburban centres of Scarborough City Centre and North York Centre as dictated by Metroplan, the high volumes of bus ridership along Finch and Sheppard Avenues, and a diverse set of alternatives (including GO Transit improvements, the then-proposed “Spadina LRT”, and express buses on streets such as Sherbourne Street) played important roles in placing a proposed subway on Sheppard Avenue a priority ahead of a line through downtown.<sup>26</sup> Meanwhile, rapid transit on Eglinton Avenue would improve links between Peel Region and Metropolitan Toronto, relieving growing traffic between the two jurisdictions.<sup>27</sup> Intense population and employment growth had occurred in the decades prior in the suburban communities outside the former City of Toronto, a trend that was predicted to continue.<sup>28</sup>
                                </span>
                            ),
                        },
                        {
                ...
                <WebColumn
                    left={[
                        { type: 'content-title', title: 'Proposed Eglinton Busway' },
                        {
                            type: 'quote',
                            text: () => (
                                <span>
                                    The proposed Eglinton West rapid transit line was recommended to be constructed initially as a busway.<sup>32</sup> The wide right-of-way along Eglinton Avenue West – originally planned to be replaced by the Richview Expressway, would allow for buses to run in the median, with grade separations at key arterial roads.<sup>33</sup> The limited right-of-way in the eastern section meant a short tunnel section would be needed to allow the alignment to veer north-east to the CN Belt Line right-of-way, where the busway would continue on the surface until reaching Eglinton West Station.<sup>34</sup> Here, images of the MBTA’s Silver Line, a system of bus routes operating along dedicated bus right-of-ways on the surface and briefly underground show a system with several similarities to what was proposed along Eglinton, albeit in a much more urban setting.<sup>35</sup>
                                </span>
                            ),
                        },
                        {
                ...
                <WebColumn
                    ...
                    right={[
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    Approved by Metro Toronto council by 1986, the plan was to be implemented in phases according to the Network 2011 plan, with council agreeing with the plan for a subway on Sheppard Avenue from Yonge Street to Victoria Park Avenue to be the priority, much to the dismay of municipal officials in Etobicoke, York, and Peel Region who wanted rapid transit on Eglinton Avenue first.<sup>37</sup> Officials from the three municipal bodies were further dismayed at the plan’s commitment to construct only a busway on Eglinton, rather than a light rail line or a subway, with the plan only specifying that it could be replaced with a subway – eventually.<sup>38</sup> The plan saw further opposition from surrounding municipal and regional governments including York, Peel, and Durham Regions who sought funding for their transportation plans centred around the then proposed Highway 407, and who saw Network 2011 as competition for such funding.<sup>39</sup>
                                </span>
                            ),
                        },
                        {
                ...
                <WebColumn
                    oneColumn={true}
                    center={[
                        { type: 'content-title', title: 'Post-Network 2011 Future Expansion' },
                        {
                            type: 'img',
                        ...
                        },
                        {
                            ...
                            text: () => (
                                <span>
                                    The Network 2011 plan also laid out potential future extensions to the rapid transit network after the Network 2011 projects had been completed.<sup>49</sup> For the proposed downtown subway, the plan envisioned extensions west via Front Street and the rail corridor, with two potential alignments further west along the rail line or north along Roncesvalles Avenue after passing the King-Queen-Queensway-Roncesvalles intersection.<sup>50</sup> An extension of the downtown subway north of Pape to Eglinton Avenue was also proposed to run along Pape Avenue, onto the Millwood viaduct, and north-east along Overlea Boulevard, similar to the proposed alignment of the Ontario Line more than thirty years later.<sup>51</sup> The Sheppard subway was envisioned to be extended westwards, passing underneath Downsview airport and north to run west along both the Finch hydro corridor and Finch Avenue.<sup>52</sup> After meeting Highway 27 (known as Etobicoke Parkway in the Network 2011 plan) the alignment would veer south along the road before meeting and running south along the Manby (Etobicoke) hydro corridor, with a terminus at Kipling Station.<sup>53</sup>
                                </span>
                            ),
                        },
                    ]}
