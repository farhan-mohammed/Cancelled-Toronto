				...
				<WebColumn
					...
					right={[
						...
						},
						{
							...
							text: () => (
								<span>
									Network 2011 was a 1985 plan by the Toronto Transit Commission for transit
									expansion, named for the target completion date of 2011. The plan focused on three
									new rapid transit lines: a subway along Sheppard Avenue from Downsview in the west
									to Scarborough City Centre in the east, a new rapid transit corridor on Eglinton
									Avenue West initially composed of express buses linking Mississauga to Eglinton West
						...
						},
						{
							...
							text: () => (
								<span>
									Furthermore, an extension of the Spadina line from Wilson Station to the Downsview
									Area would allow for transfers between the Yonge-University-Spadina line and the
									future Sheppard subway.<sup>2</sup> All-in-all, the plan would cost $2.7 billion, 25
						...
						},
						{
							...
							text: () => (
								<span>
									The findings of the study were then broken down into three more detailed studies
									offering further analysis of the ridership and feasibility of each of the corridors:
									the Sheppard/Finch Rapid Transit Study, the Downtown Rapid Transit Study, and the
									Eglinton West Rapid Transit Study.<sup>6</sup> The outcomes of these studies and the
									recommended alignments were combined to create Network 2011, which utilised the
									findings of the three studies to recommend suggested phases in constructing the plan
									according to Metro Toronto planning objectives. The Metro Toronto official plan of
									the time (Metroplan) called for the creation of a multi-centred urban structure
									within Metro Toronto, with the development of nodes which would act as major
					...
					right={[
						{
							...
							text: () => (
								<span>
									...
									of the Network 2011 plan.<sup>11</sup> A downtown subway that would aim to relieve
						...
						},
						{
							...
							text: () => (
								<span>
									...
									according to the Network 2011 plan, with council deciding on a subway on Sheppard
									Avenue from Yonge Street to Victoria Park Avenue as the priority, much to the dismay
									of municipal officials in Etobicoke, York, and Peel Region who wanted rapid transit
									on Eglinton Avenue first.<sup>13</sup> Officials from the three municipal bodies
									were further appalled at the plan’s commitment to construct only a busway on
						...
						{ type: 'img', adjust: { hide: true }, src: '1980/C.jpg' },
						{
							...
							text: () => (
								<span>
									...
									timeframe, beginning with a Sheppard subway between Yonge Street to Victoria Park
									Avenue to be constructed between 1989-1994.<sup>17</sup> Then, a downtown subway
									between Pape Station on the Bloor-Danforth Line in the east to approximately the
									intersection of Spadina Avenue and Front Street in the west would be constructed in
									the years of 1994-1999.<sup>18</sup> Then, between 1999-2004, rapid transit on
									Eglinton Avenue West would be constructed, initially as a partially grade-separated
									busway, with the possibility of converting it to a subway later.<sup>19</sup>{' '}
									Finally, between 2004-2010, the Sheppard subway would be extended on both ends from
				...
				<WebColumn
					left={[
						{ type: 'content-title', title: 'scarborough town Centre' },
						{
							...
							text: () => (
								<span>
									Scarborough City Centre, pictured, an emerging central business district that would
									be the planned eventual terminus of the Sheppard subway.<sup>21</sup> Planning in
									Metro Toronto at the time de-emphasised growth in the downtown, taking action such
									as restricting office development to protect adjacent communities and reduce the
									pressure of redevelopment for historic structures within them.<sup>22</sup> New
									central business districts such as Scarborough City Centre were intended to receive
									the majority of new office developments, something planners hoped would decrease the
					...
					right={[
						{ type: 'img', adjust: { hide: true }, src: '1980/D.jpg' },
						{
							...
							text: () => (
								<span>
									The plan saw further opposition from surrounding municipal and regional governments
									including York, Peel, and Durham Regions who sought funding for their transportation
						...
						},
						{
							...
							text: () => (
								<span>
									Ultimately, difficulties in funding the plan quickly derailed the timelines proposed
									in the plan. The then-Liberal provincial government – who was not involved in the
									development of the Network 2011 plan, baulked at the $75 million a year from the
									province necessary for a full build-out and decided to conduct a full study of all
									transit proposals in the province.<sup>24</sup> Completed in May of 1988, the report
						...
						},
						{
							...
							text: () => (
								<span>
									Although much of what Network 2011 proposed was never built in the timeframes
									proposed, elements of the plan were highly influential to the plans of subsequent
									provincial and municipal governments and remain so. The Sheppard subway, a key
									element of the Network 2011 plan was funded several years later under the Rapid
									Transit Expansion Program and opened in 2003, ten years after the original proposed
									opening date of 1993 detailed in Network 2011. Meanwhile today, plans for a downtown
