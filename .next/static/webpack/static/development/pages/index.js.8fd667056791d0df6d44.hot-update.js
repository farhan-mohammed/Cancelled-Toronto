...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(mainSite, [{
    ...
    value: function render() {
      ...
      var trigger = this.state.hamburger && this.state.pooped ? 'outer-containerOpen' : '';
      ...
      return __jsx("div", {
        ...
        onClick: function onClick() {
          console.log(_this2.state.pooped);

          _this2.setState({
            pooped: !_this2.state.pooped
          });
        },
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "Hi Danny, Click me to change the hamburger style ", __jsx("br", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 30
        },
        __self: this
      }), "Current Style:", this.state.pooped ? '1' : '2'), this.props.children);
    }
  }]);
...
//# sourceMappingURL=index.js.8fd667056791d0df6d44.hot-update.js.map